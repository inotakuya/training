...
ここでは、２つの nn 次元ベクトル x={x1,x2,...,xn}x={x1,x2,...,xn} と y={y1,y2,...,yn}y={y1,y2,...,yn} の距離を計算してみましょう。
...
Input
１行目に整数 nn が与えられます。２行目にベクトル xx の要素 {x1,x2,...xn}{x1,x2,...xn}、
３行目にベクトル yy の要素 {y1,y2,...yn}{y1,y2,...yn} が空白区切りで与えられます。入力はすべて整数値です。
